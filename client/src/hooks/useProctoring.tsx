...
export function useProctoring(applicationId: string | undefined, onTerminate: () => void) {
    ...
    const ProctoringView = () => (
        <div className= "fixed bottom-6 right-6 z-50 w-48 h-36 bg-slate-900 border-2 border-slate-700/50 rounded-xl overflow-hidden shadow-2xl flex items-center justify-center" >
        <video ref={ videoRef } autoPlay playsInline muted className = "w-full h-full object-cover bg-slate-950" />
