      ...
      <aside className="w-80 border-r border-slate-800 bg-slate-900/50 flex flex-col">
        ...
        <div className="flex-1 overflow-auto">
          {mockConversations.map((c) => (
            ...
            >
              <p className="font-medium text-slate-100">{c.with}</p>
          ...
          <>
            ...
            <div className="p-4 border-t border-slate-800 flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-2.5 rounded-lg bg-slate-900 border border-slate-700 text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-brand-500"
              />
              <button
                type="button"
                className="px-4 py-2.5 rounded-lg bg-brand-500 text-slate-100 hover:bg-brand-600 flex items-center gap-2"
              >
