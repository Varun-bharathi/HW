  ...
  return (
    <div className="max-w-2xl space-y-8">
      <div>
        ...
        <p className="mt-1 text-slate-600">Editable recruiter information</p>
      </div>
      {error && (
      ...
      <form onSubmit={handleSubmit} className="rounded-xl border border-slate-200 bg-slate-50/50 p-6 space-y-4">
        <div className="flex items-center gap-4 mb-6">
          <div className="w-16 h-16 rounded-full bg-brand-500/20 flex items-center justify-center">
            <User className="w-8 h-8 text-brand-400" />
          </div>
          <div>
            <p className="font-medium text-slate-950">Recruiter</p>
        ...
        <div>
          ...
          <input
            ...
            value={form.email}
            readOnly
            className="w-full px-4 py-3 rounded-lg bg-slate-100 border border-slate-300 text-slate-600 cursor-not-allowed"
          />
        ...
        <button
          type="submit"
          disabled={saving}
          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-brand-500 text-slate-950 font-medium hover:bg-brand-600 disabled:opacity-50"
        >
