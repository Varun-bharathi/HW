  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-100">Edit job</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 rounded-lg bg-slate-900 border border-slate-700 text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-brand-500"
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full px-4 py-3 rounded-lg bg-slate-900 border border-slate-700 text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-brand-500 min-h-[180px]"
        ...
        <div>
          ...
          <input
            ...
            className="w-full max-w-[120px] px-4 py-3 rounded-lg bg-slate-900 border border-slate-700 text-slate-100 focus:outline-none focus:ring-2 focus:ring-brand-500"
          />
        </div>
        ...
        <div className="flex flex-wrap gap-3 pt-4">
          <button
            ...
            className="px-6 py-3 rounded-lg bg-brand-500 text-slate-100 font-medium hover:bg-brand-600 disabled:opacity-50 transition-colors"
          >
          ...
          {job.status === 'draft' && (
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-emerald-600 text-slate-100 font-medium hover:bg-emerald-500 disabled:opacity-50 transition-colors"
            >
