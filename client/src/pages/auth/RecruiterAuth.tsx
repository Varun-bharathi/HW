...
const formClass =
  'w-full px-4 py-3 rounded-lg bg-slate-50 border border-slate-300 text-slate-950 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent'
    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-slate-200 bg-slate-50/50 p-8">
          ...
          <p className="mt-1 text-slate-600">Sign in to manage jobs and candidates</p>
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded-lg bg-brand-500 text-slate-950 font-medium hover:bg-brand-600 disabled:opacity-50 transition-colors"
            >
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-slate-200 bg-slate-50/50 p-8">
          <h1 className="text-2xl font-bold text-slate-950">Recruiter sign up</h1>
          <p className="mt-1 text-slate-600">Create an account to post jobs and hire</p>
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            {error && (
              <div className="p-3 rounded-lg bg-red-500/10 border border-red-500/30 text-red-400 text-sm">
                {error}
