    ...
    <div className="space-y-8">
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-2xl font-bold text-slate-100">{myApps.length}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-2xl font-bold text-slate-100">{jobs.filter((j) => j.status === 'live').length}+</p>
            </div>
        ...
        <div className="rounded-xl border border-slate-800 bg-slate-900/50 p-5">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-2xl font-bold text-slate-100">2</p>
            </div>
      ...
      <div className="rounded-xl border border-slate-800 bg-slate-900/50 overflow-hidden">
        <div className="p-4 border-b border-slate-800 flex items-center justify-between">
          <h2 className="text-lg font-semibold text-slate-100">Recent applications</h2>
          <Link
            to="/seeker/applications"
        ...
        <div className="divide-y divide-slate-800">
          {recentApps.length === 0 ? (
            ...
            recentApps.map((app) => (
              ...
              >
                <div>
                  <p className="font-medium text-slate-100">{app.job?.title ?? 'Job'}</p>
      ...
      <div className="rounded-xl border border-slate-800 bg-slate-900/50 overflow-hidden">
        <div className="p-4 border-b border-slate-800 flex items-center justify-between">
          <h2 className="text-lg font-semibold text-slate-100">Suggested jobs</h2>
          <Link
            to="/seeker/jobs"
