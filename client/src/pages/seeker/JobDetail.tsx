        ...
        {hasApplied ? (
          <div className="flex flex-col gap-2">
            ...
            <button
              ...
              className="px-6 py-3 rounded-lg bg-emerald-500 text-slate-100 font-medium hover:bg-emerald-600 transition-colors"
            >
          ...
          <button
            onClick={handleApply}
            disabled={applying}
            className="px-6 py-3 rounded-lg bg-emerald-500 text-slate-100 font-medium hover:bg-emerald-600 disabled:opacity-50 transition-colors"
          >
