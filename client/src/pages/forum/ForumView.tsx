    ...
    <div className="min-h-screen bg-black">
      <header className="border-b border-slate-800">
        <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2 font-semibold text-lg text-slate-100">
          ...
          <nav className="flex items-center gap-4">
            <Link to="/auth/recruiter/login" className="text-slate-400 hover:text-slate-100 text-sm">
              Recruiter
            </Link>
            <Link to="/auth/job-seeker/login" className="text-slate-400 hover:text-slate-100 text-sm">
              Job Seeker
            </Link>
          </nav>
        </div>
      ...
      <main className="max-w-5xl mx-auto px-6 py-8">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-100">Community forum</h1>
            ...
            <div className="space-y-1">
              {mockCategories.map((cat) => (
                <button
                  ...
                  className={`w-full text-left px-4 py-3 rounded-lg transition-colors ${selectedCategory === cat.slug ? 'bg-brand-500/20 text-brand-300' : 'hover:bg-slate-800 text-slate-300'
                    }`}
                >
